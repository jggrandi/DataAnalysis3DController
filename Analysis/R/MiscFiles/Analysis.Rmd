...
```{r workdistibution}
workDistribution <- read.csv("varianceAjustedTask3and4.csv", header = FALSE,  sep=",")
workDistribution
```
...
The Kruskal-Wallis test failed to reject equality of medians across different group sizes for work distribution balance (H(2) = 4.482, p = 0.11)
