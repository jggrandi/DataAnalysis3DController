...
As the `r teamTimeCorr.P` is greater than 0.05, we assume that there is no correlation between team members and time to complete the tasks. In the other hand, `r teamErrorCorr.P` is < 0.0001, so there is a strong correlation between team members and errors performed. At this point we don't know if the errors grow with more team members or in the other way around.
