...
ggplot(error, aes(x=group, y=errors)) + geom_boxplot()+labs(title="Group size vs. Task accuracy",x="Group Size", y = "Accuracy")+theme_bw()+ scale_x_discrete(breaks=c("Error.T1", "Error.T2", "Error.T3", "Error.T4"),labels=c("1", "2", "3","4"))
