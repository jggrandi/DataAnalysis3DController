...
if(qntusers == 2)
  users <- select(X22.2.Task1.2016.06.10.18.12.34,ends_with(".1"),ends_with(".2"), -starts_with("User"),-starts_with("Con")) #select only user action in object transformation 
if(qntusers == 3)
