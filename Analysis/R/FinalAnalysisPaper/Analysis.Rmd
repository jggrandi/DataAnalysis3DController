---
title: 'Data Analysis of the Paper Design and Evaluation of a Handheld-based 3D User
  Interface for Collaborative Object Manipulation '
...
ggplot(time, aes(x=group, y=time)) + geom_boxplot()+labs(x="Group Size", y = "Time (seconds)")+theme_bw()+ theme(panel.grid.minor = element_blank())+ scale_x_discrete(breaks=c("V1", "V2", "V3", "V4"),labels=c("1", "2", "3","4"))+ scale_y_continuous(limits = c(0, 300), expand = c(0, 0),breaks = c(0,50,100,150,200,250,300))
```
...
errGr <- ggplot(error, aes(x=group, y=error)) + geom_boxplot()+labs(x="Group Size", y = "Error")+theme_bw()+ theme(panel.grid.minor = element_blank())+ scale_x_discrete(breaks=c("V5", "V6", "V7", "V8"),labels=c("1", "2", "3","4"))+ scale_y_continuous(limits = c(0, 12), expand = c(0, 0),breaks = c(0,2,4,6,8,10,12))
df1 <- data.frame(a = c(1,1:4,4), b = c(11, 11, 11, 11,11, 11))
df2 <- data.frame(a = c(1,1:3,3), b = c(10.2, 10.2, 10.2, 10.2, 10.2))
df3 <- data.frame(a = c(2,2:4,4), b = c(9.4, 9.4, 9.4, 9.4, 9.4))
df4 <- data.frame(a = c(3,3:4,4), b = c(8.6, 8.6, 8.6, 8.6))
errGr + geom_line(data = df1, aes(x = a, y = b),linetype="dotted") + annotate("text", x = 2.5, y = 11.1, label = "****", size = 5)+ 
     geom_line(data = df2, aes(x = a, y = b),linetype="dotted") + annotate("text", x = 2, y = 10.3, label = "*", size = 5)+
     geom_line(data = df3, aes(x = a, y = b),linetype="dotted") + annotate("text", x = 3, y = 9.5, label = "**", size = 5)+
     geom_line(data = df4, aes(x = a, y = b),linetype="dotted") + annotate("text", x = 3.5, y = 8.7, label = "*", size = 5)
...
```{r roles_plot}
rolesGr <- ggplot(sourceDataRoles, aes(x=as.character(V1), y=V2)) + geom_boxplot()+labs(x="Group Size", y = "Roles Swap")+theme_bw()+theme(panel.grid.minor = element_blank())+scale_x_discrete(breaks=c("1", "2", "3", "4"),labels=c("1", "2", "3","4"))+ scale_y_continuous(limits = c(0, 56), expand = c(0, 0),breaks = seq(0,56,by=8))
df1 <- data.frame(a = c(1,1:4,4), b = c(54, 54, 54, 54,54,54))
df2 <- data.frame(a = c(1,1:3,3), b = c(51, 51, 51, 51, 51))
df3 <- data.frame(a = c(2,2:3,3), b = c(48, 48, 48, 48))
df4 <- data.frame(a = c(2,2:4,4), b = c(45, 45, 45, 45,45))
rolesGr + geom_line(data = df1, aes(x = a, y = b),linetype="dotted") + annotate("text", x = 2.5, y = 54.1, label = "****", size = 5)+ 
  geom_line(data = df2, aes(x = a, y = b),linetype="dotted") + annotate("text", x = 2, y = 51.1, label = "****", size = 5)+
  geom_line(data = df3, aes(x = a, y = b),linetype="dotted") + annotate("text", x = 2.5, y = 48.1, label = "**", size = 5)+
  geom_line(data = df4, aes(x = a, y = b),linetype="dotted") + annotate("text", x = 3, y = 45.1, label = "****", size = 5)
...
taskT <- ggplot(tasksTime, aes(x=as.character(task), y=time)) + geom_boxplot()+labs(x="Tasks", y = "Time (seconds)")+theme_bw()+theme(panel.grid.minor = element_blank())+scale_x_discrete(breaks=c("Time.task.3", "Time.task.4"),labels=c("First Trial", "Second Trial"))+ scale_y_continuous(limits = c(0, 300), expand = c(0, 0),breaks = c(0,50,100,150,200,250,300))
df1 <- data.frame(a = c(1,1:2,2), b = c(290, 290, 290, 290))
taskT + geom_line(data = df1, aes(x = a, y = b),linetype="dotted") + annotate("text", x = 1.5, y = 290.1, label = "**", size = 5)



tasksError <- gather(sourceDataTasks, "task", "error", 4:5)
summary(tasksError)
ggplot(tasksError, aes(x=as.character(task), y=error)) + geom_boxplot()+labs(x="Tasks", y = "Error")+theme_bw()+theme(panel.grid.minor = element_blank())+scale_x_discrete(breaks=c("Error.task.3", "Error.task.4"),labels=c("First Trial", "Second Trial"))+ scale_y_continuous(limits = c(0, 9), expand = c(0, 0),breaks = c(0,1.5,3,4.5,6,7.5,9))
```
...
```{r userUX}
UserConfort <- read.csv("UserConfort.csv", sep=",")
ggplot(UserConfort, aes(x=Action, y=Answer)) + geom_boxplot()+ coord_flip() +labs(x="Transformations", y = "Answers")+theme_bw()+ theme(panel.grid.minor = element_blank())
```
